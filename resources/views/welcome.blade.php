    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
            ...
            <form action="/search" method="GET" id="search-form">
                <div
                    class="flex rounded-t-xl border-1 border-blue-100 overflow-hidden max-w-md mx-auto font-[sans-serif] ml-6">

                    <input type="text" placeholder="Search Something..." name="searchContent"
                           class="w-full outline-none bg-white text-sm px-5 py-3 text-black"/>
